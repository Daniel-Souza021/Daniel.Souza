class ContactsController < ApplicationController
  ...
  http_basic_authenticate_with name:"daniel", password: "0123", only: :destroy
  ...
  def update
    respond_to do |format|
      ...
      if @contact.update(contact_params)
        format.html { redirect_to contacts_path, notice: I18n.t('messages.uptaded')}
  ...
  @kind_options_for_select = Kind.all
    ...
    def contact_params
      ...
      address_attributes: [:strret, :city, :state],
